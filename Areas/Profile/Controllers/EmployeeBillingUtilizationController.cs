    ...
    public class EmployeeBillingUtilizationController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            else
            {
                ...
                return View(db.CBS_EmployeeBillingUtilization.Where(x => x.EmpID == userEmpId).ToList());
            }
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            if (!(cBS_EmployeeBillingUtilization.EmpID == CurrentUser.GetEmpID(this.Session, this.User) || (User.IsInRole("Admin") || User.IsInRole("Manager") || User.IsInRole("CBS_EmployeeBillingUtilization_Manage"))))
            {
