	...
	public class TrainingsController : Controller
	{
		...
		public ActionResult Index()
		{
			...
			else
			{
				...
				return View(db.CBS_Trainings.Where(x => x.EmpID == userEmpId).ToList());
			}
		}
		...
		public ActionResult Create([Bind(Include = "ID,Employee_Name,Year,Course_Name,Training_Provider,Training_Type,Category,Training_Month,Time_Duration,Investment,EmpID,Training_Focus,ForeignOrLocal,Approved,EditedBy,TargetRowID")] CBS_Trainings cBS_Trainings)
		{
		...
		[HttpPost]
		[ValidateAntiForgeryToken]
		public ActionResult Edit([Bind(Include = "ID,Employee_Name,Year,Course_Name,Training_Provider,Training_Type,Category,Training_Month,Time_Duration,Investment,EmpID,Training_Focus,ForeignOrLocal,Approved,EditedBy,TargetRowID")] CBS_Trainings cBS_Trainings)
		{
			if (ModelState.IsValid)
			{
				if (User.IsInRole("Admin") || User.IsInRole("Manager") || User.IsInRole("CBS_Trainings_Manage"))
