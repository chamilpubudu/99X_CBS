    ...
    public class PublicAppearencesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            else
            {
                ...
                return View(db.CBS_PublicAppearences.Where(x =>x.EmpID == userEmpId).ToList());
            }
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            if (!(cBS_PublicAppearences.EmpID == CurrentUser.GetEmpID(this.Session, this.User) || (User.IsInRole("Admin") || User.IsInRole("Manager") || User.IsInRole("CBS_PublicAppearences_Manage"))))
            {
